...
class TachieDisplay(QMainWindow):
    def __init__(self):
        ...
        self.dialog_widget.setStyleSheet(
            "background-color: rgba(255, 255, 255, 180); border: 1px solid gray; border-radius: 10px; box-shadow: 0px 0px 15px rgba(0, 0, 0, 0.3);"
        )  # Add transparency and shadow effect
