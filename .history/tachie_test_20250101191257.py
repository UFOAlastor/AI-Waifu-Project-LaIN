...
class TachieDisplay:
    def __init__(self, root):
        ...
        # 设置窗口透明度
        self.dialog_frame.attributes("-alpha", self.dialog_opacity)  # 默认透明度 90%
        ...
        self.close_button.place(
            x=self.window_width - (self.window_width - self.dialog_width) // 2,
    ...
    def on_resize(self, event):
        ...
        # 调整关闭按钮位置
        self.close_button.place(
            x=(width - self.dialog_width) // 2 - 30,
            y=height - (height - self.dialog_height) // 3 - 30,
        )
