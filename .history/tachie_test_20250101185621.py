...
class TachieDisplay:
    def __init__(self, root):
        ...
        dialog_x =  window_height*0.1
        dialog_y =  window_height*0.5
        dialog_width = window_width*0.8
        dialog_height = window_height*0.3
        ...
        self.dialog_frame.place(
            ...
            width=self.settings.get("dialog_width", 400),
            height=self.settings.get("dialog_height", 160),
        )
