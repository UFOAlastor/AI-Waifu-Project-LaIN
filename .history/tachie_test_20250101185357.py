...
class TachieDisplay:
    def __init__(self, root):
        ...
        self.dialog_frame.place(
            x=self.settings.get("dialog_x", self.settings.get('window_width', 600)*0.1),
            y=self.settings.get("dialog_y", self.settings.get('window_height', 800)*0.5),
            width=self.settings.get("dialog_width", self.settings.get('window_width', 600)*0.8),
            height=self.settings.get("dialog_height", self.settings.get('window_height', 800)*0.3),
        )
