...
class TachieDisplay(QMainWindow):
    def __init__(self):
        ...
        self.dialog_widget.setStyleSheet(
            f"background-color: rgba(255, 255, 255, {255*self.dialog_opacity}); border: 1px solid gray; border-radius: 20px;"
        )
        ...
        self.close_button.setStyleSheet(
            "background-color: red; color: white; font: bold 12pt Arial; border: none; border-radius: 10%;"
        )
