...
class TachieDisplay:
    def __init__(self, root):
        ...
        self.window_height = self.settings.get('window_height', 600)
        self.dialog_x =  self.settings.get('dialog_x', window_width*0.1)
        self.dialog_y =  self.settings.get('dialog_y', window_height*0.5)
        self.dialog_width = self.settings.get('dialog_width', window_width*0.8)
        self.dialog_height = self.settings.get('dialog_height', window_height*0.2)
        ...
        # 设置窗口透明度
        self.root.attributes("-alpha", self.dialog_opacity)  # 默认透明度 90%
    ...
    def on_resize(self, event):
        ...
        # 调整关闭按钮位置
        self.close_button.place(x=width - self.dialog_width + 10, y=height - self.dialog_height + 10)
        ...
        self.dialog_frame.place(
            ...
            y=height - self.dialog_height - 50,
            width=self.dialog_width,
            height=self.dialog_height,
        )
