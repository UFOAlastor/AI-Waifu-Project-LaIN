...
class Model:
    def __init__(self, config_path="./config.json"):
        ...
        self.agent_id = self.settings.get("agent_id", "缺失配置文件情况下请于此处手动填入agent_id")
    ...
    def load_settings(self, config_path):
        ...
        try:
            ...
            print("配置文件未找到！请于model_module.py手动填入agent_id")
            return {}
        except json.JSONDecodeError:
            print("配置文件格式错误！请于model_module.py手动填入agent_id")
            return {}
