...
class TachieDisplay:
    def __init__(self, root):
        ...
        self.close_button = tk.Button(
            self.root, text="×", command=self.root.destroy, bg="red", fg="white", font=("Arial", 12, "bold")
        )
        self.close_button.place(x=770, y=10, width=30, height=30)
    ...
    def on_resize(self, event):
        ...
        # 调整关闭按钮位置
        self.close_button.place(x=width - 30, y=10)
