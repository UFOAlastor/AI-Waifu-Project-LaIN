...
class TachieDisplay(QMainWindow):
    def __init__(self):
        ...
        self.dialog_widget.setStyleSheet(
            "background-color: rgba(255, 255, 255, 220); border: 1px solid gray; border-radius: 10px;"
        )
        ...
        # Adjust dialog_label's size and ensure it blends with the dialog's background
        self.dialog_label = QLabel("绫", self.dialog_widget)
        self.dialog_label.setStyleSheet(
            "font: bold 12pt Arial; color: #333333; margin-left: 10px;"
        )
        self.dialog_label.setAlignment(Qt.AlignLeft)
        ...
        self.dialog_text.setStyleSheet("font: 14pt Arial; background-color: rgba(255, 255, 255, 180); border: none; color: #333333;")
