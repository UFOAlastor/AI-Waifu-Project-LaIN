...
class TachieDisplay:
    def __init__(self, root):
        ...
        self.character_image_id = self.canvas.create_image(self.window_width / 2, self.window_height / 2, image=self.character_photo)
    ...
    def update_image_size(self):
        ...
        # 根据宽度和高度计算缩放比例
        scale_factor = min(scale_width / self.original_width, scale_height / self.original_height)
    ...
    def update_dialog_position(self):
        ...
        self.dialog_height = int(window_height * 0.1875)  # 对话框高度为窗口高度的150/800
