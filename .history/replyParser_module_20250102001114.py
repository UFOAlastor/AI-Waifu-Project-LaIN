...
if __name__ == "__main__":
    ...
    # test_reply = ""
    test_reply = final_message = "思考 ||| 这是一个无效的输入||| 12345"
    ...
    if not parse_status:
        tachie_expression = parsed_reply.get("表情")
        Chinese_message = parsed_reply.get("中文")
        Japanese_message = parsed_reply.get("日语")
